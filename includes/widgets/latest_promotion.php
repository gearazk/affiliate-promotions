	...
	class Aff_Latest_Promotion_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description' => esc_html__( 'Affiliate promtions widget', AFFILIATE_PROMOTIONS_PLUG ),
			);
			
			parent::__construct( AFFILIATE_PROMOTIONS_PREFIX.'latest_promotions' , esc_html__( 'eC-Gem: Products Carousel', AFFILIATE_PROMOTIONS_PLUG ), $opts );
		}
				...
				if ( $latest_products->have_posts() ) :?>
                    ...
                    <div class="inner-wrapper">
                        ...
                        <div class="products-carousel-wrap">
                            ...
                            <ul class="latest-product-items latest-products-main" data-slick='<?php echo $carousel_args_encoded; ?>'>
		...
		function form( $instance ) {
			...
			?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><strong><?php esc_html_e( 'Title:', AFFILIATE_PROMOTIONS_PLUG ); ?></strong></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
            </p>

            <p>
                <label for="<?php echo  esc_attr( $this->get_field_id( 'product_category' ) ); ?>"><strong><?php esc_html_e( 'Select Category:', AFFILIATE_PROMOTIONS_PLUG ); ?></strong></label>
				<?php
				$cat_args = array(
					'orderby'         => 'name',
					'hide_empty'      => 0,
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'product_type' ) ); ?>"><strong><?php _e( 'Product Type:', AFFILIATE_PROMOTIONS_PLUG ); ?></strong></label>
				<?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_name('product_number') ); ?>">
					<?php esc_html_e('Number of Products:', AFFILIATE_PROMOTIONS_PLUG); ?>
                </label>
		...
		function dropdown_product_type( $args ) {
			...
			$choices = array(
				'latest' 	=> esc_html__( 'Latest', AFFILIATE_PROMOTIONS_PLUG ),
				'featured' 	=> esc_html__( 'Featured', AFFILIATE_PROMOTIONS_PLUG ),
			);
